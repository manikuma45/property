...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { line_name: @station.line_name, name: @station.name, to_foot: @station.to_foot } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { line_name: @station.line_name, name: @station.name, to_foot: @station.to_foot } }
